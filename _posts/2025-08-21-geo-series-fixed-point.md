...
date: 2025-08-21  
permalink: /posts/2025/08/geo-series-fixed-point-1/
tags:
  - math
---
...
\end{equation}
$$
is a geometric series with a common ratio \(a\). If \(a \< 1\), it is called the "decay rate" the series converges to \(\frac{k}{1-a}\). One important extension of this idea is the power series, where the leading coefficient \(k\) is no longer uniform, but instead itself forms a sequence, i.e., 
$$
